...
export const styles = StyleSheet.create({
  ...
  brandScroll: { marginTop: 20, minHeight: 80 },
  ...
  productImageContainer: { height: 140, justifyContent: 'center', alignItems: 'center', backgroundColor: '#fff', padding: 10, position: 'relative' },
  favoriteButton: { position: 'absolute', top: 8, right: 8, width: 44, height: 44, borderRadius: 22, backgroundColor: 'rgba(255,255,255,0.95)', alignItems: 'center', justifyContent: 'center', zIndex: 5 },
  ...
  productPriceGroup: { flexShrink: 1 },
  productPrice: { fontSize: 16, fontWeight: 'bold', color: THEME.primary },
  productOriginalPrice: { fontSize: 12, color: THEME.textGray, textDecorationLine: 'line-through', marginTop: 2 },
